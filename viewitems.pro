...
UBUNTU_TRANSLATION_DOMAIN="viewitems.liu-xiao-guo"
...
aptest.commands = bash $$PWD/viewitems/tests/autopilot/run
aptest.depends  = sub-viewitems

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/viewitems/tests/unit
unittest.depends  = sub-viewitems
